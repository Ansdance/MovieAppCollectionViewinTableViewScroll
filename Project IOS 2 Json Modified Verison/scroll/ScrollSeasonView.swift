...
class ScrollSeasonView: UIScrollView {
    ...
    private func renderTokens() {
        ...
        for token in tokens {
            ...
            tokenButton.heightAnchor.constraint(equalToConstant: 54).isActive = true
            tokenButton.widthAnchor.constraint(equalToConstant: 80).isActive = true
